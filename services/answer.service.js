...
class AnswerService{
    async createAnswer(answer){
        const newAnswer = await db.query('INSERT INTO Answers (answer_id, answer_number, answer_text, answer_value) values ($1, $2, $3, $4) RETURNING *',
            [answer.answer_id, answer.answer_number, answer.answer_text, answer.answer_value])
